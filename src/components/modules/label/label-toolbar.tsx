...
export function LabelToolbar({
  ...
  const draft = useLabelQueryParams((s) => s.draft);
  const patchDraft = useLabelQueryParams((s) => s.patchDraft);
  const commit = useLabelQueryParams((s) => s.commit);
  const reset = useLabelQueryParams((s) => s.reset);
