    ...
    <div className="flex flex-wrap items-center justify-between gap-3 pt-3">
      <div className="flex items-center gap-3 text-[12.5px] text-muted-foreground">
        <div className="flex items-center gap-2">
          ...
          >
            <SelectTrigger className="h-7 min-w-[72px] rounded-lg bg-secondary text-[12.5px]">
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
              {[10, 20, 50, 100].map((n) => (
        ...
        {pages.map((p, i) =>
          p === "..." ? (
            ...
            <button
              ...
              className={cn(
                "inline-flex h-7 min-w-7 items-center justify-center rounded-xl px-2.5 text-[12.5px] font-medium transition-colors",
                p === safePage
